        ...
        <div class="w-full max-w-2xl mx-auto bg-white p-5 rounded shadow-md">
            ...
            <form method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="confirm_password" id="confirm_password" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                </div>
